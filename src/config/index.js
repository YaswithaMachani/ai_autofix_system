...
const envSchema = z.object({
  ...
  // Universal language/platform support
  LANGUAGE: z.string().default('node'),          // node | python | generic
  TEST_COMMAND: z.string().default('npm test'),   // e.g. pytest / npm test / python -m unittest
  LINT_COMMAND: z.string().default('npm run lint') // e.g. flake8 / npm run lint / pylint
});
...
module.exports = {
  ...
  lintCommand: config.LINT_COMMAND
};
